...
import { ChevronLeft, ChevronRight, Grid, Map } from 'lucide-react';
...
const Items = () => {
  ...
  const { items, loading, totalCount } = useItems({
    ...
    page,
    limit: viewMode === 'map' ? 100 : limit, // Load more items for map view
  });
        ...
        {viewMode === 'grid' ? (
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground text-center">
              Showing {items.length} items on the map. Click a marker to see details.
            </p>
          </div>
        )}
      </div>
